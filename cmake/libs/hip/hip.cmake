...
function(add_hip_to_target TARGET_NAME COMPONENTS)
    ...
    if (WIN32)        
        target_compile_options(${TARGET_NAME} PRIVATE $<$<COMPILE_LANGUAGE:HIP>:--rocm-path=${HIP_PATH}>) 
        target_compile_options(${TARGET_NAME} PRIVATE $<$<COMPILE_LANGUAGE:HIP>:--rocm-device-lib-path=${HIP_PATH}/lib/llvm/amdgcn/bitcode>)
    endif()
