...
function (add_generated_test TARGET_NAME TEST_SOURCE EXTENSION DIR)                       
        ...
        if(${ENABLE_CUDA})
            if(${CUDA_VERSION_MAJOR} GREATER_EQUAL 13)	
                option(CUDA_ENABLE_ALIGNED_VECTOR4_TYPES "Enable aligned 16/32 types in CUDA 13 and newer" OFF)
                if (${CUDA_ENABLE_ALIGNED_VECTOR4_TYPES})
                    target_compile_definitions(${TARGET_NAME_EXT} PRIVATE CUDA_ENABLE_ALIGNED_VECTOR4_TYPES)
                endif()
            endif() 
        endif()
