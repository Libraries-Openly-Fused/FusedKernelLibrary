...
function(configure_test_target_flags TARGET_NAME TEST_SOURCE DIR)
        ...
        set_target_properties(${TARGET_NAME} PROPERTIES CXX_STANDARD 23 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO)   
        if (MSVC)
            target_compile_options(${TARGET_NAME} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:/std:c++23preview>)
        endif()         
