...
#      define UTEST_SATURATE_ULONG_CPP_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define UTEST_SATURATE_ULONG_CPP_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define UTEST_SATURATE_ULONG_CPP_DEPRECATED __declspec(deprecated)
#endif
