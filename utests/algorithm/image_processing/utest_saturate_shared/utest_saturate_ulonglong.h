...
#ifndef FK_UTEST_SATURATE_ULONGLONG_H
#define FK_UTEST_SATURATE_ULONGLONG_H
...
#ifdef WIN32
#include "utest_saturate_ulonglong_export.h"
#endif
...
#ifdef WIN32
int UTEST_SATURATE_ULONGLONG_EXPORT launchulonglong();
#else
