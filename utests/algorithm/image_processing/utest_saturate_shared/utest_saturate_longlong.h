...
#ifndef FK_UTEST_SATURATE_LONGLONG_H
#define FK_UTEST_SATURATE_LONGLONG_H
...
#ifdef WIN32
#include "utest_saturate_longlong_export.h"
#endif
...
#ifdef WIN32
int UTEST_SATURATE_LONGLONG_EXPORT launchlonglong();
#else
