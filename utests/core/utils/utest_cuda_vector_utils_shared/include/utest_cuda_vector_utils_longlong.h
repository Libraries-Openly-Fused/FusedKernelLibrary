...
#ifndef FK_UTEST_CUDA_VECTOR_UTILS_LONGLONG_H
#define FK_UTEST_CUDA_VECTOR_UTILS_LONGLONG_H
...
#ifdef WIN32
#include "utest_cuda_vector_utils_longlong_export.h"
#endif

#if defined(__GNUC__) && !defined(_WIN32)
#define  EXPORT_FN_LONGLONG  __attribute__((visibility("default")))
#else
#define  EXPORT_FN_LONGLONG 
#endif

namespace fk::testlonglong {
...
#ifdef WIN32
int UTEST_CUDA_VECTOR_UTILS_LONGLONG_EXPORT launchlonglong();
#else
int  EXPORT_FN_LONGLONG launchlonglong();
#endif


#endif // FK_UTEST_CUDA_VECTOR_UTILS_LONGLONG_H
