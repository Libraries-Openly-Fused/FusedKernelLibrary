...
#ifndef FK_UTEST_CUDA_VECTOR_UTILS_USHORT_H
#define FK_UTEST_CUDA_VECTOR_UTILS_USHORT_H
...
#ifdef WIN32
#include "utest_cuda_vector_utils_ushort_export.h"
#endif

#if defined(__GNUC__) && !defined(_WIN32)
#define  EXPORT_FN_USHORT  __attribute__((visibility("default")))
#else
#define  EXPORT_FN_USHORT 
#endif
...
#ifdef WIN32
int UTEST_CUDA_VECTOR_UTILS_USHORT_EXPORT launchushort();
#else
int  EXPORT_FN_USHORT launchushort();
#endif


#endif // FK_UTEST_CUDA_VECTOR_UTILS_USHORT_H
