...
#ifndef FK_UTEST_CUDA_VECTOR_UTILS_ULONGLONG_H
#define FK_UTEST_CUDA_VECTOR_UTILS_ULONGLONG_H
...
#ifdef WIN32
#include "utest_cuda_vector_utils_ulonglong_export.h"
#endif

#if defined(__GNUC__) && !defined(_WIN32)
#define  EXPORT_FN_ULONGLONG  __attribute__((visibility("default")))
#else
#define  EXPORT_FN_ULONGLONG 
#endif

namespace fk::testulonglong {
...
#ifdef WIN32
int UTEST_CUDA_VECTOR_UTILS_ULONGLONG_EXPORT launchulonglong();
#else
int  EXPORT_FN_ULONGLONG launchulonglong();
#endif


#endif // FK_UTEST_CUDA_VECTOR_UTILS_ULONGLONG_H
