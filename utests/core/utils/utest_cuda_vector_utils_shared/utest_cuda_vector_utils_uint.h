...
#ifndef FK_UTEST_CUDA_VECTOR_UTILS_UINT_H
#define FK_UTEST_CUDA_VECTOR_UTILS_UINT_H
...
#ifdef WIN32
#include "utest_cuda_vector_utils_uint_export.h"
#endif

#if defined(__GNUC__) && !defined(_WIN32)
#define  EXPORT_FN_UINT  __attribute__((visibility("default")))
#else
#define  EXPORT_FN_UINT 
#endif
...
#ifdef WIN32
int UTEST_CUDA_VECTOR_UTILS_UINT_EXPORT launchuint();
#else
int  EXPORT_FN_UINT launchuint();
#endif


#endif // FK_UTEST_CUDA_VECTOR_UTILS_UINT_H
