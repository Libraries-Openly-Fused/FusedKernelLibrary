...
#ifndef FK_UTEST_CUDA_VECTOR_UTILS_ULONG_H
#define FK_UTEST_CUDA_VECTOR_UTILS_ULONG_H
...
#ifdef WIN32
#include "utest_cuda_vector_utils_ulong_export.h"
#endif

#if defined(__GNUC__) && !defined(_WIN32)
#define  EXPORT_FN_ULONG  __attribute__((visibility("default")))
#else
#define  EXPORT_FN_ULONG 
#endif
...
#ifdef WIN32
int UTEST_CUDA_VECTOR_UTILS_ULONG_EXPORT launchulong();
#else
int  EXPORT_FN_ULONG launchulong();
#endif


#endif // FK_UTEST_CUDA_VECTOR_UTILS_ULONG_H
