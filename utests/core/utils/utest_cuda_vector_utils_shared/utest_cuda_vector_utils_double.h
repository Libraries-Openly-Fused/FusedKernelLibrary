...
#ifndef FK_UTEST_CUDA_VECTOR_UTILS_DOUBLE_H
#define FK_UTEST_CUDA_VECTOR_UTILS_DOUBLE_H
...
#ifdef WIN32
#include "utest_cuda_vector_utils_double_export.h"
#endif

#if defined(__GNUC__) && !defined(_WIN32)
#define  EXPORT_FN_DOUBLE  __attribute__((visibility("default")))
#else
#define  EXPORT_FN_DOUBLE 
#endif
...
#ifdef WIN32
int UTEST_CUDA_VECTOR_UTILS_DOUBLE_EXPORT launchdouble();
#else
int  EXPORT_FN_DOUBLE launchdouble();
#endif


#endif // FK_UTEST_CUDA_VECTOR_UTILS_DOUBLE_H
